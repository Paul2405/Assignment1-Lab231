...
import haudq.dtos.UserDto;
import haudq.daos.UserDao;
import haudq.util.VerifyUtil;
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (action.equals("Continue to login")) {
                ...
                if (flag) {
                    String reCaptchaRespone = request.getParameter("g-recaptcha-response");
                    flag = VerifyUtil.verify(reCaptchaRespone);
                    if (!flag) {
                        errorMessage = "Recaptcha invalid";
                    }
                }
                if (!flag) {
                    request.setAttribute("ERROR", errorMessage);
